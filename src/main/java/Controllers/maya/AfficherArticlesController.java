...
public class AfficherArticlesController {
    ...
    public void initialize() {
        ...
        for (ArticleConseil article : articles) {
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/maya/ArticleCard.fxml"));
...
//    }
    ...
    private void goBack(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/maya/AjouterArticle.fxml"));
