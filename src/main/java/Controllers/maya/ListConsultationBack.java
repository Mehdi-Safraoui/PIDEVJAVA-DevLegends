...
public class ListConsultationBack {

    @FXML private TableView<Consultation> tableConsultations;
    @FXML private TableColumn<Consultation, String> colId;  // Colonne pour l'ID
    ...
    public void initialize() {
        ...
        colId.setCellValueFactory(new PropertyValueFactory<>("id")); // Associe l'ID de l'objet Consultation
        ...
        comboTri.getItems().addAll("Id", "Nom", "Prénom", "Âge", "Date");
        comboTri.setValue("Id"); // Valeur par défaut
    ...
    // Méthode pour ajouter le bouton Modifier dans la table
    ...
    // Méthode pour ajouter le bouton Supprimer dans la table
    ...
    void trierConsultations(ActionEvent event) {
        ...
        ObservableList<Consultation> sortedConsultations = FXCollections.observableArrayList(consultations);

        switch (critere) {
            case "Nom":
                sortedConsultations.sort((c1, c2) -> triDescendant ?
            ...
            case "Id":
                sortedConsultations.sort((c1, c2) -> triDescendant ?
                        Integer.compare(c2.getId(), c1.getId()) : // Tri décroissant
                        Integer.compare(c1.getId(), c2.getId())); // Tri croissant
                break;
        ...
        // Mettre à jour le TableView avec les consultations triées
        tableConsultations.setItems(sortedConsultations);
    }


    // Méthode pour revenir à l'écran d'ajout
    @FXML
