...
public class AjouterConsultationController {
    ...
    void AfficherConsultationFXML(ActionEvent event) {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/maya/AfficherConsultation.fxml"));
    ...
    private void goToLandingPage() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/maya/LandingPage.fxml"));
