...
public class AfficherPackController {
    ...
    private void openModificationWindow(Pack pack) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/malek/ModifierPack.fxml"));
            Parent root = loader.load();
    ...
    private void handleAjouterPack(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/malek/AjouterPack.fxml"));
            Parent root = loader.load();
